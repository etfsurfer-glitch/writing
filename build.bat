...
echo.
echo ============================================================
echo   N Writing 블로그 자동화  —  빌드 스크립트  v1.32
echo ============================================================
echo.
...
echo ============================================================
echo   빌드 완료!
echo   인스톨러 위치: %RELEASE_DIR%\NWriting_v1.32_Setup.exe
echo ============================================================
echo.
echo   GitHub 릴리즈 업로드 절차:
echo   1. https://github.com/etfsurfer-glitch/writing/releases/new
echo   2. Tag: 1.32  /  Title: v1.32
echo   3. NWriting_v1.32_Setup.exe 첨부 후 Publish
echo.
pause
