...
echo.
echo ============================================================
echo   N Writing 블로그 자동화  —  빌드 스크립트  v1.48
echo ============================================================
echo.
...
echo ============================================================
echo   빌드 완료!
echo   인스톨러 위치: %RELEASE_DIR%\NWriting_v1.48_Setup.exe
echo ============================================================
echo.
echo   GitHub 릴리즈 업로드 절차:
echo   1. https://github.com/etfsurfer-glitch/writing/releases/new
echo   2. Tag: 1.48  /  Title: v1.48
echo   3. NWriting_v1.48_Setup.exe 첨부 후 Publish
echo.
pause
